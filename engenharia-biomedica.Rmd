...
Para a principal utilização dos dados foi definidos os __data frames__ unb.adv.df, que neste caso contêm alguns informações de qual a natureza da pesquisa produzida, qual aluno produziu, seus respectivos orientadores, o ano e etc. Também foi definido os dados importantes do arquivo profile.json, gerando o __data frame__ unb.prof.df, que já está limpo, com as principais colunas definidas.
