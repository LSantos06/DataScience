...
Os arquivos `r json.perfil.biomed, json.perfil.auto, json.perfil.ele_p7, json.perfil.ele_p8 ` apresentam dados sobre o perfil de todos os docentes vinculados a programas de pós-graduação, em engenharia biomédia, automação, engenharia elétrica (p7 e p8), da UnB, entre 2010 e 2017. 
...
json.advise.ele_p8 <- "dados-2018-2/engenharia-eletrica-p7/282.advise.json"
file.info(json.advise.ele_p7)

```

Os arquivos `r json.advise.biomed, json.advise.auto, json.advise.ele_p7, json.advise.ele_p8 ` apresenta dados sobre o orientações de mestrado e doutorado feitas por todos os docentes vinculados a programas de pós-graduação em engenharia biomédica e demais, da UnB, entre 2010 e 2017. 
...
Os arquivos `r json.producao.bibliografica.biomed, json.producao.bibliografica.auto, json.producao.bibliografica.ele_p7 e json.producao.bibliografica.ele_p8 ` apresenta dados sobre a produção bibliográfica gerada por todos os docentes vinculados a programas de pós-graduação, em engenharia elétrica p7 e também as demais, da UnB, entre 2010 e 2017. 
...
Os arquivos `r json.list.biomed` apresenta o id de todos docentes vinculados a programas de pós-graduação descritos acima da UnB, entre 2010 e 2017.Porém tal arquivo se mostra inútil, haja visto que só contém o id e que as outras variáveis como __"nome"__ sempre tem seu valor igual a __""__. 
...
Os arquivos `r json.graph.biomed, json.graph.ele_p7, json.graph.ele_p8 e json.graph.auto` apresenta redes de colaboração na co-autoria de artigos científicos, feitas entre os docentes vinculados a programas de pós-graduação da UnB, entre 2010 e 2017.
...
```{r}
unb.prof.ele_p8 <- fromJSON("dados-2018-2/engenharia-eletrica-p7/282.profile.json")
```
