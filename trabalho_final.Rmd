...
Código em R para limpeza e construção dos dados de interesse a serem analisados na próxima etapa da metodologia adotada:
```{r}
...
unb.prof.ele_p8.df <- unb.prof.ele_p8.df.professores %>% 
  ...
  left_join(
    unb.prof.ele_p8.df.capes %>% 
      ...
      summarise(n_distinct(AreaPos)), 
    by = "idLattes")
#glimpse(unb.prof.ele_p8.df)
head(unb.prof.ele_p8.df,3)
## Mostrando dados processados referente ao arquivo 281.publication.json
#glimpse(unb.pub.ele_p8.df)
#Podemos ver que contêm natureza, titulo, periodico , autores .... 
head(unb.pub.ele_p8.df,3)
## Mostrando dados processados referente ao arquivo 281.advise.json
#glimpse(unb.adv.ele_p8.df)
#Podemos ver que contêm natureza, titulo, autores, ano, nome aluno, orientadores .... 
...
unb.prof.ele_p7.df <- unb.prof.ele_p7.df.professores %>% 
  ...
  left_join(
    unb.prof.ele_p7.df.capes %>% 
      ...
      summarise(n_distinct(AreaPos)), 
    by = "idLattes")
glimpse(unb.prof.ele_p7.df)
head(unb.prof.ele_p7.df,3)
## Mostrando dados processados referente ao arquivo 281.publication.json
glimpse(unb.pub.ele_p7.df)
#Podemos ver que contêm natureza, titulo, periodico , autores .... 
head(unb.pub.ele_p7.df,3)
## Mostrando dados processados referente ao arquivo 281.advise.json
glimpse(unb.adv.ele_p7.df)
#Podemos ver que contêm natureza, titulo, autores, ano, nome aluno, orientadores .... 
