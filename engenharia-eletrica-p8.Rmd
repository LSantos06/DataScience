...
```{r}
json.perfil <- "dados-2018-2/engenharia-eletrica-p8/281.profile.json"
...
```{r}
json.advise <- "dados-2018-2/engenharia-eletrica-p8/281.advise.json"
...
```{r}
json.producao.bibliografica <- "dados-2018-2/engenharia-eletrica-p8/281.publication.json"
...
```{r}
file.info('data/dados-2018-2/engenharia-eletrica-p8/281.graph.json')
```
...
```{r}
unb.prof <- fromJSON("dados-2018-2/engenharia-eletrica-p8/281.profile.json")
```
...
```{r}
unb.adv <- fromJSON("dados-2018-2/engenharia-eletrica-p8/281.advise.json")
names(unb.adv)
...
```{r}
unb.pub <- fromJSON("dados-2018-2/engenharia-eletrica-p8/281.publication.json")
names(unb.pub)
...
unb.prof.json <- read_file("dados-2018-2/engenharia-eletrica-p8/281.profile.json")
